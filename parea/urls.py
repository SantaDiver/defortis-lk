...
from .views import SyncView, LoginView, log_user_out, gpr, default_redirect, \
    talks, upload_file, delete_file, download_file, documents, information, \
    photo, contacts, addContact, deleteContact, video, project
...
urlpatterns = [
    ...
    url(r'^(?P<selected_project_id>\d+)/project/$', project, name='project'),
    ...
    url(r'^(?P<selected_project_id>\d+)/video/$', video, name='video'),
    url(r'^(?P<selected_project_id>\d+)/contacts/$', contacts, name='contacts'),
    url(r'^(?P<selected_project_id>\d+)/addContact/$', addContact, name='addContact'),
    url(r'^(?P<selected_project_id>\d+)/deleteContact/$', deleteContact, name='deleteContact'),
